...
#'
#' @description Sets the transformation functions for a `feature_data` object.
#'
...
#'
#' @return A `feature_data` object with the updated transformation functions.
#' @export
...
#' @describeIn set_transformations Method for setting transformations in a `feature_data` object.
setMethod("set_transformations", signature = c(object = "feature_data"),
