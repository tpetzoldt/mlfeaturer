...
#'
#' @return A `feature_data` object or a `data.frame` with the transformed data.
#'
...
#' @describeIn transform_data Method for transforming data in a `feature_data` object.
setMethod("transform_data", signature = c(object = "feature_data"),
          function(object, ...) {
            df <- object@data
...
#' @describeIn transform_data Method for transforming data in a `feature_data` object and user-defined functions (deprecated).
setMethod("transform_data", signature = c(object = "feature_data", funs = "list", params = "missing"),
...
setMethod("transform_data", signature = c(object = "data.frame", funs="missing", params="feature_params"),
